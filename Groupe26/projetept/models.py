...
class autre(models.Model):
     ...
     Jour_De_Cour=models.CharField(blank=False,max_length=12,choices=jour,primary_key=True,default='lundi')
     jour_semaine=models.DateField(auto_now_add=False,auto_now=False,blank=True)
     filiere=models.CharField(max_length=20,choices=fil,default='IM')
     def __str__(self):
        return f'{self.Jour_De_Cour}'
...
class licences(models.Model):
    ...
    jour=models.ForeignKey(autre,on_delete=models.CASCADE, default='lundi')
